...
- knowledgebase-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- knowledgebase-ui: main application module, development time
- knowledgebase-production: module that produces a production mode WAR for deployment
